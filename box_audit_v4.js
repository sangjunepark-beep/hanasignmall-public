...
function render(){
  ...
  res.forEach((r,i)=>{
    ...
    else if(r.v4Suspicious)H+='<span style="padding:6px 10px;background:#fd7e14;color:#fff;border-radius:4px;font-size:11px;font-weight:bold" title="동일라벨 일괄제거 / 광범위추가 / 단순빼기 패턴 감지">🔍 v4 의심</span>';
